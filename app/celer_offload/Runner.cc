...
celeritas::SetupOptions celeritas_options(bool use_device, OpticalHitRecorder* hit_recorder)
{
    ...
    so.optical = [&] {
        ...
        opts.capacity = celeritas::inp::OpticalStateCapacity::from_default(use_device);
